...
# Solution:
Now this is a bit tricker , as you've 100 pwds and you cant try each and everyting so what i did was i modified the code little so that it automatically runs and prints the flag
```python
import hashlib
...
def level_4_pw_check():
    ...
    for i in range(100):
        if correct_pw_hash == hash_pw(pos_pw_list[i]):
...
#   (Only 1 is correct)
```
![image](https://github.com/LAVANYA-PIDIKITI/picoCTF-Writeup/assets/98797256/e3a66574-8397-4d1c-8fde-57639f976b12)
